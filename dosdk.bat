...
"C:\Users\thwin\.androidsdk\cmdline-tools\latest\bin\sdkmanager.bat" "platform-tools" "platforms;android-36.1" "build-tools;36.0.0" --sdk_root="C:\Users\thwin\.androidsdk" >> sdkinstall.log 2>&1
